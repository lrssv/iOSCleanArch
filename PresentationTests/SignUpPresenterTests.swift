...
extension SignUpPresenterTests {
    ...
    func makeSignUpViewModel(name: String? = "anyname", email: String? = "invalid_email@any.com", password: String? = "any_password", passwordConfirmation: String? = "any_password") -> SignUpViewModel{
